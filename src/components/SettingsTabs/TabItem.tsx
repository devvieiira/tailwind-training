...
const TabItem = ({ value, title, isSelected = false }: TabItemProps) => {
	return (
		<Tabs.Trigger
			value={value}
			className="relative group px-1 pb-4 text-sm font-medium text-zinc-500 dark:data-[state=active]:text-violet-400 dark:text-zinc-400 hover:text-violet-700 dark:hover:text-violet-300 data-[state=active]:text-violet-700 outline-none"
		>
